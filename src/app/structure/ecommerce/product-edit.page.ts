...
export class EcommerceProductEdit {
  ...
  constructor(
    ...
    this.myGroup = fb.group({
      ...
      limitMeet: [this.Setting.CalendarRestriction, Validators.required],
      about: [this.Setting.about, Validators.required],
...
updateSetting(){
 this.shopS.updateSetting(this.myGroup.value);
}
  mychange(i, val) {
    console.log(i, val);
  }
